...
# beleza/ e gerado/ são do gerador de sites, não da fábrica: o --delete não pode levá-las
rsync -a --delete --exclude beleza --exclude gerado ../sites/assets/ public/s/assets/
